...
namespace RequireJSWithMVC.Extensions
{
    public static class PathHelpers
    {
        public static string ScriptsPath(this HtmlHelper helper, string pathWithoutScripts)
        {
            ...
            fullPath = VirtualPathUtility.ToAbsolute(scriptsPath + pathWithoutScripts + "?v=" + helper.AssemblyVersion());
#endif
            return fullPath;
        }
        ...
        public static string StylesPath(this HtmlHelper helper, string pathWithoutStyles)
        {
            ...
            fullPath = VirtualPathUtility.ToAbsolute(stylesPath + pathWithoutStyles + "?v=" + helper.AssemblyVersion());
#endif
            return fullPath;
        }
    }
